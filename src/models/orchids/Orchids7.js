...
let Orchids7 = ((scene, id, object, modalsLoaded) => {
  ...
  pointLight.position.set(-284, -1, 26);
  ...
  lod.position.set(-280, -4.3, 23.5)
  lod.updateMatrix();
  lod.matrixAutoUpdate = false;
  lod.addLevel(cube2, 30);
  scene.add( lod );
  loader.load("https://mubico.s3.us-east-2.amazonaws.com/orchidWithbaseDraco7.gltf", function (gltf) {
