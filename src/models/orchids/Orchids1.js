...
let Orchids1 = ((scene, id, object, modalsLoaded) => {
  ...
  pointLight.position.set(-290, -1, 3);
  ...
  lod.position.set(-294, -4.1, 1)
  lod.updateMatrix();
  lod.matrixAutoUpdate = false;
  lod.addLevel(cube2, 30);
  scene.add( lod );
  loader.load("https://mubico.s3.us-east-2.amazonaws.com/orchidWithbaseDraco.gltf", function (gltf) {
