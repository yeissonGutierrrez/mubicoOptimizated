...
let Orchids5 = ((scene, id, object, modalsLoaded) => {
...
// gltf.scene.position.set(-184, -5, -28)
  ...
  pointLight.position.set(-210, -1, 33);
  ...
  lod.position.set(-209, -3.5, 37)
  lod.updateMatrix();
  lod.matrixAutoUpdate = false;
  lod.addLevel(cube2, 30);
  scene.add( lod );
  loader.load("https://mubico.s3.us-east-2.amazonaws.com/orchidWithbaseDraco5.gltf", function (gltf) {
