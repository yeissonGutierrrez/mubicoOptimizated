let structureOne = ((scene, modalsLoaded) => {
  ...
  manager.onLoad = function ( ) {
    modalsLoaded.push('structureOne')
  ...
  lod.addLevel(cube4, 50);
  scene.add( lod );
  loader.load("https://mubico.s3.us-east-2.amazonaws.com/structureOneDraco.gltf", function (gltf) {
